//  Patched to fix issue "MOD-875"
//  IE fix for residual scrollbar if popup needed one on the last show.
//  see line #216. 'overflow: visible' property added

define("anaplan/patches/dijit/popup", [
    ...
    var PopupManager = declare(null, {
        ...
        hide: function(/*Widget*/ widget){
            ...
            domStyle.set(wrapper, {
                ...
                overflowY: "visible", // MOD-875: IE fix for residual scroll bar if popup needed one on last show
