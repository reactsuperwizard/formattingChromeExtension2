define("anaplan/patches/dijit/focus", [
	"dojo/aspect",
	...
	var FocusManager = declare([Stateful, Evented], {
		...
		_onBlurNode: function(/*DomNode*/ node){
			...
			this._clearActiveWidgetsTimer = setTimeout(lang.hitch(this, function(){
				...
				////// BEGIN PATCH #BIZ-649 //////
				// TODO: #BIZ-649 - This fix is incomplete.
				// In IE11, msMaxTouchPoints has been deprecated in favour of the standard maxTouchPoints,
				// so this test may not work in IE12. However, the fix might not be needed in IE12 either.
				// There are also remaining known issues that need to be worked out properly. See JIRA.

				if ( window.navigator.msMaxTouchPoints > 0 ) {
					// Skip the following _setStack call IFF IE 10+ AND the device has a touchscreen
                    // TODO: Need to better understand why this fixes anything.
					return;
				}
				////// END PATCH #BIZ-649 //////
